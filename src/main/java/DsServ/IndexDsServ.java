 ...
 * @author break
 */
@WebServlet(name = "IndexDsServ", urlPatterns = {"/IndDs"})
public class IndexDsServ extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        getServletContext().getRequestDispatcher("/indeds.jsp").forward(request, response);
    }
